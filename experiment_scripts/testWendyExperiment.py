...
print("Bandwidth")
print(wendyExperiment.calculateBandwidthFastHotStuff(f, batch_size))
print(wendyExperiment.calculateBandwidthWendy(f, batch_size, view_diff_bits))
print(wendyExperiment.calculateBandwidthSBFT(f, batch_size))
print(wendyExperiment.calculateBandwidthCasper(f, batch_size))
print(wendyExperiment.calculateBandwidthCasperRelaxedRule(f, batch_size, view_diff_bits))
